...
Open `donate.html`, find these two lines near the bottom and fill them in:
```js
...
Until those are filled in nothing can be charged.
...
4. You should return to a **Thank you** message, and see the payment in your Stripe Dashboard.
